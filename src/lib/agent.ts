...
async function discoverPeople(existingNames: string[], desiredCount: number): Promise<{
  ...
  if (attempts.length < Math.max(8, Math.floor(desiredCount / 2))) {
    ...
    const fallback: DiscoveryTarget[] = [
      ...
      { company: 'Pave', role: 'Solutions Consultant', category: 'Target Company', hook: 'Fintech', thesis: 'Compensation infrastructure plus consultative customer work is a useful fintech GTM angle.', priority: 81 },
      { company: 'Persona', role: 'Solutions Engineer', category: 'Target Company', hook: 'Fintech', thesis: 'Identity, fraud, and implementation work gives Avery a specific customer-facing infra question.', priority: 81 },
      { company: 'Vanta', role: 'Customer Engineer', category: 'Target Company', hook: 'FDE', thesis: 'Security compliance automation with customer engineering is a strong solutions-style path.', priority: 80 },
      { company: 'Tavus', role: 'Forward Deployed Engineer', category: 'Target Company', hook: 'AI', thesis: 'Video AI deployment creates a concrete question about applied AI and customers.', priority: 80 },
      { company: 'Cognition', role: 'Forward Deployed Engineer', category: 'Target Company', hook: 'AI', thesis: 'Agentic coding products plus FDE work map to Avery’s AI-agent interests.', priority: 83 },
      { company: 'Abridge', role: 'Implementation Lead', category: 'Senior Executive', hook: 'AI', thesis: 'Healthcare AI implementation is a non-obvious applied AI customer workflow.', priority: 78 },
      { company: 'Sierra', role: 'Solutions Architect', category: 'Target Company', hook: 'AI', thesis: 'Conversational AI for enterprises gives a direct customer-facing AI angle.', priority: 83 },
      { company: 'Baseten', role: 'Developer Relations', category: 'Target Company', hook: 'AI', thesis: 'AI infrastructure plus developer-facing work is a useful technical GTM path.', priority: 79 },
      { company: 'Modal Labs', role: 'Developer Relations', category: 'Target Company', hook: 'AI', thesis: 'AI compute infrastructure and developer-facing education are strong technical GTM topics.', priority: 79 },
      { company: 'EvenUp', role: 'Solutions Engineer', category: 'Target Company', hook: 'AI', thesis: 'Vertical AI and legal workflow deployment is a concrete customer-facing AI angle.', priority: 78 },
      { company: 'Watershed', role: 'Solutions Engineer', category: 'Target Company', hook: 'FDE', thesis: 'Climate software plus enterprise solutions gives a different customer-facing technical market.', priority: 76 },
      { company: 'Middesk', role: 'Implementation Lead', category: 'Target Company', hook: 'Fintech', thesis: 'Business identity infrastructure connects fintech, risk, and customer implementation.', priority: 76 },
      { company: 'Column', role: 'Product Lead', category: 'Senior Executive', hook: 'Fintech', thesis: 'Banking infrastructure at a builder-led company gives Avery a sharper fintech question.', priority: 78 },
      { company: 'Increase', role: 'Solutions Engineer', category: 'Target Company', hook: 'Fintech', thesis: 'Banking APIs and technical customer work are close to Avery’s fintech interests.', priority: 78 },
      { company: 'Unit', role: 'Solutions Architect', category: 'Target Company', hook: 'Fintech', thesis: 'Embedded finance plus solution design gives a concrete customer-facing fintech angle.', priority: 77 },
      { company: 'Taktile', role: 'Solutions Engineer', category: 'Target Company', hook: 'Fintech', thesis: 'Decisioning infrastructure in fintech creates a strong risk and implementation conversation.', priority: 77 },
      { company: 'Parabola', role: 'Solutions Engineer', category: 'Target Company', hook: 'FDE', thesis: 'Workflow automation with customer operators is a strong applied product angle.', priority: 76 },
      { company: 'Hightouch', role: 'Solutions Engineer', category: 'Target Company', hook: 'FDE', thesis: 'Data activation plus solutions engineering gives Avery a good customer/data question.', priority: 76 },
      { company: 'Retool', role: 'Forward Deployed Engineer', category: 'Target Company', hook: 'FDE', thesis: 'Internal tools and FDE work are directly relevant to Avery’s builder/customer interests.', priority: 82 },
      { company: 'Palantir', role: 'Forward Deployed Architect', category: 'Target Company', hook: 'FDE', thesis: 'The classic FDE path gives Avery a benchmark for customer-facing technical roles.', priority: 82 },
      { company: 'Ramp', role: 'Solutions Engineer', category: 'Target Company', hook: 'Fintech', thesis: 'Fintech plus sales engineering gives a crisp bridge between finance and customer-facing tech.', priority: 82 },
      { company: 'Stripe', role: 'Solutions Architect', category: 'Target Company', hook: 'Fintech', thesis: 'Payments infrastructure and technical customer work are deeply relevant to Avery.', priority: 82 },
      { company: 'Carta', role: 'Implementation Consultant', category: 'Target Company', hook: 'Fintech', thesis: 'Equity infrastructure plus customer implementation maps to Avery’s finance/software interests.', priority: 77 },
      { company: 'Anysphere', role: 'Growth', category: 'Similar Trajectory', hook: 'Founder', thesis: 'AI developer tools and early growth roles give Avery a strong startup operator angle.', priority: 78 },
      { company: 'Perplexity', role: 'Growth', category: 'Similar Trajectory', hook: 'AI', thesis: 'Consumer AI growth and product strategy creates a different AI operator conversation.', priority: 76 },
      { company: 'Anthropic', role: 'Product Specialist', category: 'Target Company', hook: 'AI', thesis: 'AI product specialists sit between customers, product, and technical teams.', priority: 80 },
      { company: 'Cohere', role: 'Solutions Architect', category: 'Target Company', hook: 'AI', thesis: 'Enterprise LLM deployment gives Avery a high-quality applied AI conversation.', priority: 80 },
      { company: 'OpenAI', role: 'Solutions Architect', category: 'Target Company', hook: 'AI', thesis: 'Enterprise AI deployment is relevant if a reachable solutions person is publicly listed.', priority: 78 },
      { company: 'Howard University', role: 'Founder', category: 'Black Network', hook: 'Black Network', thesis: 'Black founders from HBCU networks can be high-signal identity and operator conversations.', priority: 74 },
      { company: 'AfroTech', role: 'Speaker', category: 'Black Network', hook: 'Black Network', thesis: 'AfroTech speakers often have public evidence and direct Black tech network relevance.', priority: 76 },
      { company: 'Amherst College', role: 'Founder', category: 'Amherst Alum', hook: 'Amherst', thesis: 'Amherst founders are strong warm-hook conversations even outside target companies.', priority: 79 },
      { company: 'Menlo School', role: 'Founder', category: 'Menlo Alum', hook: 'Menlo', thesis: 'Menlo founders create a strong personal hook and operator-learning angle.', priority: 78 },
    ];
